...
from .utils.estimator import to_predictor_no_save, get_default_model_dir
...
class Separator(object):
    ...
    def __init__(self, params_descriptor, MWF=False, stft_backend="tensorflow", multiprocess=True):
        """ Default constructor.
        ...
        # TODO: assert params_descriptor
        self._descriptor = params_descriptor
