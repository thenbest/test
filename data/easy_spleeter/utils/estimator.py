...
# added by horie
DEFAULT_EXPORT_DIRECTORY = "pb_model"
...
# added by horie
def to_predictor_no_save(descriptor):
    ...
    """
    directory = join(RESOURCES_ROOT, descriptor)
    return predictor.from_saved_model(directory)
